...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_bracketleft,   incnmaster,     {.i = +1 } },						// brings one window 
	{ MODKEY,                       XK_bracketright,  incnmaster,     {.i = -1 } },						// brings one window 
	{ MODKEY|ShiftMask,             XK_a,      				setmfact,       {.f = -0.05} }, 					// resize window - makes left windows smaller
	{ MODKEY|ShiftMask,             XK_s,      				setmfact,       {.f = +0.05} },					// resize window - makes right windows smaller
	{ MODKEY,             					XK_Tab,    				zoom,           {0} },                   // brings window to the master 
	{ MODKEY|ShiftMask,             XK_Tab,    				view,           {0} },										// moves to last used workspace
